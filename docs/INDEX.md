...
- `src/server/`: checked development routes for missing previews, launcher and creation calls, NPC dialogue with its current quest snapshot, and local speech traffic (src/server/CONTRACT.md).
