...
- `SimBridge.create(atlas, connections, buildings, params, npcTypes)` receives the Atlas blueprint, Connections output, loaded interior NPC support, simulation parameters and optional Naming type set described by [the simulation input contract](../../../../simulation/CONTRACT.md).
...
- Creation passes one assembled world's blueprint, Networks, interiors and NPC type set into `createSimulation` once.
