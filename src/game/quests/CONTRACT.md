...
- A goto or talk objective whose place is a parcel gets an area ring at that parcel's anchor while the step is active, so the place the HUD names has a mark in the world. A talk objective also stands its cast at that parcel through `Crowd.castMember` while the step is active and inside the hour it names, whatever the rota says; outside that hour the HUD says when it opens and nobody is stood there.
