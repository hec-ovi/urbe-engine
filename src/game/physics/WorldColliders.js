 ...
 * Interiors are heavy, so each building's floors and stairs become a collider
 * only while the player is near it, and go away again further out. Hysteresis
 * between the two radii stops a boundary from thrashing.
 */
