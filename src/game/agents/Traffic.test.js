...
/**
 * The traffic contract: cars fill free positions on Connections lanes inside
 * the population window, ride the authored 3D path, and never drive over the
 * player. Each of those is a thing a player sees go wrong from the pavement.
 */
describe( 'Traffic', () => {
