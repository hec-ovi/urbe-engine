...
- `E_KIT_PIECES` and `E_KIT_PLACEMENT`: an unreadable plan shell or a placement record naming a plan the world lacks, published by the [Kit runtime](city/kit/CONTRACT.md).
