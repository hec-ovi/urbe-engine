...
import { Converse, DialogContextService } from '../../../quests/dist/index.js';
 ...
 * world (its `out` directory: blueprint.json, npc-types.json) keeps one context
...
export class TalkService {
	 ...
	 */
	async reply( { out, npc, behavior, line, timeMin } ) {
	...
	async #world( out ) {
		...
		world = { port, context, converse: new Converse( this.llm ) };
