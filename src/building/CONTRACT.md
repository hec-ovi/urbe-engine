...
- An unresolved key produces a named magenta material and appears in the resolver report. Texture-load failures settle readiness; scalar-map failures use the catalog factors. Theme, binding and JSON fetch failures propagate ordinary errors.
