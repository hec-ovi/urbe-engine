...
- Simulation save schema, game NPC agents continuity-save schema and playable quest transit-state schema. City resources and quest bundles cross this boundary as checksummed file-reference envelopes.
