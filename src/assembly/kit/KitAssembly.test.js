...
describe( 'kit assembly', () => {
	...
	it( 'writes a record of the frame alone, over any shell that stood there, the same bytes every time', () => {
		...
		// A 40 by 56 m lot is five bays by seven, drawn as the mid business it
		// carries, and its massing stands on them.
		expect( [ wide.record.plan ] ).toEqual( [ 'plain-commercial-mid-5x7x4f' ] );
